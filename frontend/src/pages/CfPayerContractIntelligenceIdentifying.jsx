...
// Auto-generated page for: Payer contract intelligence identifying negotiation opportun

export default function CfPayerContractIntelligenceIdentifying() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-payer-contract-intelligence-identifying-', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Payer contract intelligence identifying negotiation opportun</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Payer contract intelligence identifying negotiation opportunities.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Payer contract intelligence identifying negotiation opportun'}
        </button>
      </form>
