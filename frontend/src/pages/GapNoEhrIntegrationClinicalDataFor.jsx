...
// Auto-generated page for: No EHR integration (clinical data for coding context)

export default function GapNoEhrIntegrationClinicalDataFor() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-ehr-integration-clinical-data-for', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No EHR integration (clinical data for coding context)</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No EHR integration (clinical data for coding context)</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No EHR integration (clinical data for coding context)'}
        </button>
      </form>
