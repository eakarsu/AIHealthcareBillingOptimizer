...
// Auto-generated page for: No claim-prioritizer

export default function GapNoClaimPrioritizer() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-claim-prioritizer', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No claim-prioritizer</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No claim-prioritizer</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No claim-prioritizer'}
        </button>
      </form>
