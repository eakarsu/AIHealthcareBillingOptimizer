...
// Auto-generated page for: No compliance-risk checker

export default function GapNoComplianceRiskChecker() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-compliance-risk-checker', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No compliance-risk checker</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No compliance-risk checker</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No compliance-risk checker'}
        </button>
      </form>
