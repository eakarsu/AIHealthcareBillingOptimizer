...
// Auto-generated page for: No coding-recommender (suggest ICD-10/CPT from notes)

export default function GapNoCodingRecommenderSuggestIcd10cpt() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-coding-recommender-suggest-icd-10cpt', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No coding-recommender (suggest ICD-10/CPT from notes)</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No coding-recommender (suggest ICD-10/CPT from notes)</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No coding-recommender (suggest ICD-10/CPT from notes)'}
        </button>
      </form>
