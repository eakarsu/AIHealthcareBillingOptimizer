...
// Auto-generated page for: No appeal workflow automation

export default function GapNoAppealWorkflowAutomation() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-appeal-workflow-automation', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No appeal workflow automation</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No appeal workflow automation</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No appeal workflow automation'}
        </button>
      </form>
