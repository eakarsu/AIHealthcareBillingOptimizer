...
// Auto-generated page for: No denial-analyzer (predict reversals, recommend appeals)

export default function GapNoDenialAnalyzerPredictReversalsRec() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-denial-analyzer-predict-reversals-rec', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No denial-analyzer (predict reversals, recommend appeals)</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No denial-analyzer (predict reversals, recommend appeals)</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No denial-analyzer (predict reversals, recommend appeals)'}
        </button>
      </form>
