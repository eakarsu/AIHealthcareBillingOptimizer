...
// Auto-generated page for: No prior-auth approval-likelihood predictor

export default function GapNoPriorAuthApprovalLikelihoodPredic() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-prior-auth-approval-likelihood-predic', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No prior-auth approval-likelihood predictor</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No prior-auth approval-likelihood predictor</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No prior-auth approval-likelihood predictor'}
        </button>
      </form>
