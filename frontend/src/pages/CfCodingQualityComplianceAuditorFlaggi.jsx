...
// Auto-generated page for: Coding quality + compliance auditor flagging underbilling/ov

export default function CfCodingQualityComplianceAuditorFlaggi() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-coding-quality-compliance-auditor-flaggi', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Coding quality + compliance auditor flagging underbilling/ov</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Coding quality + compliance auditor flagging underbilling/overbilling and recommending training.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Coding quality + compliance auditor flagging underbilling/ov'}
        </button>
      </form>
