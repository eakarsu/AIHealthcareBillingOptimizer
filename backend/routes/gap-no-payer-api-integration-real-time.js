...
// Feature slug: gap-no-payer-api-integration-real-time
...
router.post('/', auth, (req, res) => {
  ...
  if (aiRateLimiter) return aiRateLimiter(req, res, () => handle('gap-no-payer-api-integration-real-time', req, res));
  return handle('gap-no-payer-api-integration-real-time', req, res);
});
