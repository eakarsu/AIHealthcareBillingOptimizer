...
// Feature slug: gap-no-compliance-risk-checker
...
router.post('/', auth, (req, res) => {
  ...
  if (aiRateLimiter) return aiRateLimiter(req, res, () => handle('gap-no-compliance-risk-checker', req, res));
  return handle('gap-no-compliance-risk-checker', req, res);
});
