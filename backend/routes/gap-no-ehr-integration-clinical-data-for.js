...
// Feature slug: gap-no-ehr-integration-clinical-data-for
...
router.post('/', auth, (req, res) => {
  ...
  if (aiRateLimiter) return aiRateLimiter(req, res, () => handle('gap-no-ehr-integration-clinical-data-for', req, res));
  return handle('gap-no-ehr-integration-clinical-data-for', req, res);
});
