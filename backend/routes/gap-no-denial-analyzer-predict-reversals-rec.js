...
// Feature slug: gap-no-denial-analyzer-predict-reversals-rec
...
router.post('/', auth, (req, res) => {
  ...
  if (aiRateLimiter) return aiRateLimiter(req, res, () => handle('gap-no-denial-analyzer-predict-reversals-rec', req, res));
  return handle('gap-no-denial-analyzer-predict-reversals-rec', req, res);
});
