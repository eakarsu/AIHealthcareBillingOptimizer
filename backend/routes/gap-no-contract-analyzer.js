...
// Feature slug: gap-no-contract-analyzer
...
router.post('/', auth, (req, res) => {
  ...
  if (aiRateLimiter) return aiRateLimiter(req, res, () => handle('gap-no-contract-analyzer', req, res));
  return handle('gap-no-contract-analyzer', req, res);
});
